      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            加入15,000+用户，体验多周期RSI共振分析带来的精准交易信号
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">7天免费试用</h3>
            <p className="text-blue-100 text-sm">无需信用卡，立即体验所有功能</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">安全保障</h3>
            <p className="text-blue-100 text-sm">银行级安全，保护您的数据和隐私</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">24/7支持</h3>
            <p className="text-blue-100 text-sm">专业团队随时为您提供帮助</p>
          </div>
        </div>
